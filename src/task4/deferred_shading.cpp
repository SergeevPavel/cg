...
int main()
{
	...
	Model cyborg(FileSystem::getPath("resources/objects/nanosuit/nanosuit.obj").c_str());
        ...
        Model cyborg1(FileSystem::getPath("resources/objects/cyborg/cyborg.obj").c_str());
	...
	std::vector<glm::vec3> objectPositions;
        ...
        objectScale.push_back(glm::vec3(0.25));
        objectModels.push_back(cyborg);
        
        objectPositions.push_back(glm::vec3(3.0, -0.0, 0.0));
        objectScale.push_back(glm::vec3(1.0));
        objectModels.push_back(rock);

        objectPositions.push_back(glm::vec3(-3.0, -3.0, 0.0));
        objectScale.push_back(glm::vec3(1.0));
        objectModels.push_back(cyborg1);
